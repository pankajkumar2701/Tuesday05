...
using Tuesday05.Models;
using Tuesday05.Data;
using Tuesday05.Filter;
using Tuesday05.Entities;
using Tuesday05.Authorization;
using Microsoft.AspNetCore.Authorization;

namespace Tuesday05.Controllers
{
    /// <summary>
    ...
    {
        private readonly Tuesday05Context _context;

        public RoleEntitlementController(Tuesday05Context context)
        {
            _context = context;
        }
