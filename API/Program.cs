...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Tuesday05", Version = "v1" });
...
builder.Services.AddTransient<Tuesday05Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Tuesday05 API v1");
